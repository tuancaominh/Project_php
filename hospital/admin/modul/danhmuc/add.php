...
<?php
	if(isset($_POST['ok'])){
		...
		if(mysql_num_rows($result_name) > 0){
			...
			$sql = "insert into danhmuc(danhmuc_ten,danhmuc_oder,danhmuc_trangthai) values('$name','$oder','$trangthai')";
			mysql_query($sql);
...
<br/>
<br/>
<form action="<?php echo BASEURL."admin/quantri.php?page=danhmuc&act=add";?>" method="post">
